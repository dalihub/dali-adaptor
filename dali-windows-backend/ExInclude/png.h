...
#define PNG_ALL_MNG_FEATURES        0x05
    ...
    */
    ...
    {
        long handle;
        size_t(*ReadBufferCallback)(long, char*, int);
    } TPngFile;
    ...
    struct png_struct_def
    {
        ...
        TPngFile* io_ptr PNG_DEPSTRUCT;          /* ptr to application struct for I/O functions */
...
#define PNG_FILTER_HEURISTIC_LAST       3  /* Not a valid value */
    ...
    */
    ...
    extern PNG_EXPORT(void, png_init_io) PNGARG((png_structp png_ptr, void* fp));
#endif
