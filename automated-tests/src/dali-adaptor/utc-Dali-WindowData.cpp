...
{
  // Test SetFrontBufferRenderingEnabled and IsFrontBufferRenderingEnabled
  WindowData windowData;
  windowData.SetFrontBufferRenderingEnabled(true);

  DALI_TEST_CHECK(windowData.IsFrontBufferRenderingEnabled() == true);
