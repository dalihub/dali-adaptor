...
CHECK_MODULE_AND_SET( DLOG dlog dlog_available )
...
CHECK_MODULE_AND_SET( GIO gio-2.0 [] )
...
IF( dlog_available )
  SET(DALI_DLOG_AVAILABLE 1)
  ADD_DEFINITIONS( -DDALI_DLOG_AVAILABLE )
ENDIF()

ADD_DEFINITIONS( -DPLATFORM_TIZEN )

IF( DEVICE_PROFILE )
  CHECK_MODULE_AND_SET( CYNARA_CLIENT cynara-client cynara_client_available )
  CHECK_MODULE_AND_SET( CYNARA_CREDS_SELF cynara-creds-self cynara_creds_self_available )
  IF( cynara_client_available AND cynara_creds_self_available )
    ADD_DEFINITIONS( -DDALI_PRIVILEGE_CHECK_AVAILABLE )
  ENDIF()
ENDIF()
...
ELSE()
  ...
  IF( enable_appfw )
    ...
    SET( DALI_LDFLAGS ${DALI_LDFLAGS}
      ...
      ${CYNARA_CLIENT_LDFLAGS}
      ${CYNARA_CREDS_SELF_LDFLAGS}
      ${TTS_LDFLAGS}
      ${SENSOR_LDFLAGS}
      ${BUNDLE_LDFLAGS}
...
#                           -Wno-weak-vtables
  ...
  ENDIF()
  CHECK_CXX_COMPILER_FLAG(-Wno-init-list-lifetime HAVE_NO_INIT_LIST_LIFETIME)
  IF (HAVE_NO_INIT_LIST_LIFETIME)
    ADD_COMPILE_OPTIONS( $<$<COMPILE_LANGUAGE:CXX>:-Wno-init-list-lifetime> )
  ENDIF()
  CHECK_CXX_COMPILER_FLAG(-Wno-nullability-completeness HAVE_NO_NULLABILITY_COMPLETENESS)
  IF (HAVE_NO_NULLABILITY_COMPLETENESS)
