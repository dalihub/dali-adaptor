#ifndef DALI_INTERNAL_ACCESSIBILITY_ANDROID_TTS_PLAYER_IMPL_ANDROID_H
#define DALI_INTERNAL_ACCESSIBILITY_ANDROID_TTS_PLAYER_IMPL_ANDROID_H
 ...
 */
class TtsPlayerAndroid : public Dali::Internal::Adaptor::TtsPlayer
{
...
public:
   ...
   */
  static std::unique_ptr<TtsPlayerAndroid> New(Dali::TtsPlayer::Mode mode);
   ...
   * @param mode the mode of tts-player
   */
  TtsPlayerAndroid(Dali::TtsPlayer::Mode mode);

  /**
   * Destructor
   */
  virtual ~TtsPlayerAndroid();
...
#endif // DALI_INTERNAL_ACCESSIBILITY_ANDROID_TTS_PLAYER_IMPL_ANDROID_H
