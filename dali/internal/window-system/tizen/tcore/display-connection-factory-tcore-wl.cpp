...
namespace Adaptor
{
std::unique_ptr<Dali::Internal::Adaptor::DisplayConnection> DisplayConnectionFactoryTcoreWl::CreateDisplayConnection()
{
  return Utils::MakeUnique<DisplayConnectionTcoreWl>();
}
...
std::unique_ptr<DisplayConnectionFactory> GetDisplayConnectionFactory()
{
  ...
  return Utils::MakeUnique<DisplayConnectionFactoryTcoreWl>();
}
