#ifndef DALI_GRAPHICS_GLES_RESOURCE_H
...
public:
   ...
   */
  Resource(const CreateInfo& createInfo, Graphics::EglGraphicsController& controller)
   ...
   */
  [[nodiscard]] Graphics::EglGraphicsController& GetController() const
  {
    return mController;
  }
