#ifndef DALI_INTERNAL_GRAPHICS_VULKAN_VKSURFACEXCB_H
#define DALI_INTERNAL_GRAPHICS_VULKAN_VKSURFACEXCB_H
...
class VkSurfaceXcb final : public VkSurfaceFactory
{
public:
  /**
