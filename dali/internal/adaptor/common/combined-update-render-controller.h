...
private:                                  // Attributes
  ...
  uint32_t mNumberOfFramesPerRender;          ///< The number of frames per each render.
  float    mMaximumFramesPerSecond;           ///< Maximum fps per each frames. It will be used for Vsync.
