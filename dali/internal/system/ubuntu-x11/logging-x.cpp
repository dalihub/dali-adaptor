...
void LogMessage(Dali::Integration::Log::DebugPriority level, std::string& message)
{
  ...
  switch(level)
  {
    case Dali::Integration::Log::DebugDebug: ///< Gray color
      format = "\e[1;38;5;243mDEBUG:\e[21m %s: %s\e[0m";
      break;
    case Dali::Integration::Log::DebugInfo: ///< Green color
      format = "\e[1;32mINFO:\e[21m %s: %s\e[0m";
      break;
    case Dali::Integration::Log::DebugWarning: ///< Yellow color
      format = "\e[1;33mWARN:\e[21m %s: %s\e[0m";
      break;
    case Dali::Integration::Log::DebugError: ///< Bright Red color
