...
ThreadController::ThreadController( AdaptorInternalServices& adaptorInterfaces, Integration::Graphics::Graphics& graphics, const EnvironmentOptions& environmentOptions )
