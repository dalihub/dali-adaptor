...
// From main thread.
UnifiedTriggerEventManager& UnifiedTriggerEventManager::Get()
{
  static UnifiedTriggerEventManager sUnifiedTriggerEventManager;
  return sUnifiedTriggerEventManager;
}
