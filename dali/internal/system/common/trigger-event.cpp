  ...
  mOptions(options)
{
  ...
  if(mFileDescriptor >= 0)
  {
    ...
    mFileDescriptorMonitor = std::make_unique<FileDescriptorMonitor>(mFileDescriptor, MakeCallback(this, &TriggerEvent::Triggered), FileDescriptorMonitor::FD_READABLE);
  }
  else
  {
