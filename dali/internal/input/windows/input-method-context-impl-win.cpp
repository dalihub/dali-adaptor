...
InputMethodContextPtr InputMethodContextWin::New()
{
  ...
  if ( Adaptor::IsAvailable() )
  {
    ...
    if (ecoreXwin)
    {
      ...
      manager = new InputMethodContextWin( ecoreXwin );
    }
    else
    {
...
InputMethodContextWin::InputMethodContextWin( Ecore_X_Window ecoreXwin )
//: mIMFContext(),
...
void InputMethodContextWin::CreateContext( Ecore_X_Window ecoreXwin )
{
