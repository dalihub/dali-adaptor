#ifndef DALI_INTERNAL_NATIVE_IMAGE_FACTORY_X_H
#define DALI_INTERNAL_NATIVE_IMAGE_FACTORY_X_H
...
namespace Adaptor
{
class NativeImageFactoryWin : public NativeImageFactory
{
public:
...
#endif // DALI_INTERNAL_NATIVE_IMAGE_FACTORY_X_H
