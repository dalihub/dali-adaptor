...
public:
   ...
   * @param[in] nativeImageSource contains either: pixmap of type X11 Pixmap  or is empty
...
private:
   ...
   * @param pixmap contains either: pixmap of type X11 Pixmap or is empty
   * @return pixmap x11 pixmap
   */
  ::Pixmap GetPixmapFromAny(Any pixmap) const;
