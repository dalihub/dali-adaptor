#ifndef DALI_INTERNAL_IMAGING_TIZEN_NATIVE_IMAGE_IMPL_TIZEN_H
#define DALI_INTERNAL_IMAGING_TIZEN_NATIVE_IMAGE_IMPL_TIZEN_H
 ...
 */
class NativeImageTizen : public Internal::Adaptor::NativeImage
{
public:
  /**
   ...
   */
  static NativeImageTizen* New(uint32_t                      width,
                               uint32_t                      height,
...
private:
   ...
   */
  NativeImageTizen(uint32_t                      width,
                   unsigned int                  height,
                   Dali::NativeImage::ColorDepth depth,
                   Any                           nativeImage);
