#ifndef DALI_INTERNAL_NATIVE_IMAGE_FACTORY_TIZEN_H
#define DALI_INTERNAL_NATIVE_IMAGE_FACTORY_TIZEN_H
...
namespace Adaptor
{
class NativeImageFactoryTizen : public NativeImageFactory
{
public:
...
#endif // DALI_INTERNAL_NATIVE_IMAGE_FACTORY_TIZEN_H
