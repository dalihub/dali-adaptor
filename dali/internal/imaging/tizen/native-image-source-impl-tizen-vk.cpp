...
{
  // Could perform vkCreateImageFromNativeBufferTIZEN Proc here.
  return true;
}
...
void NativeImageSourceTizen::PrepareTexture()
{
  ...
  sizeInBytes = info.planes[0].stride;

  CopyMemory(info.planes[0].ptr, {mWidth, mHeight}, {0, 0}, 0, 0, API::TextureDetails::UpdateMode::UNDEFINED );
