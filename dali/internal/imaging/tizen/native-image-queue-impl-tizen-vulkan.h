#ifndef DALI_INTERNAL_NATIVE_IMAGE_QUEUE_IMPL_TIZEN_VULKAN_H
#define DALI_INTERNAL_NATIVE_IMAGE_QUEUE_IMPL_TIZEN_VULKAN_H
 ...
 * surface lifetimes. The NativeImageQueue uses this to delay surface
 ...
 */
class NativeImageQueueTizenVulkan : public Internal::Adaptor::NativeImageQueue,
                                    public NativeImageSurfaceReference
{
public:
  /**
   * Create a new NativeImageQueueTizenVulkan internally.
   ...
   * @param[in] nativeImageQueuecontains tbm_surface_queue_h or is empty
   * @return A smart-pointer to a newly allocated image.
   */
  static NativeImageQueueTizenVulkan* New(uint32_t queueCount, uint32_t width, uint32_t height, Dali::NativeImageQueue::ColorFormat colorFormat, Any nativeImageQueue);
   ...
   * destructor
   */
  ~NativeImageQueueTizenVulkan() override;
...
private:
   ...
   * @param[in] nativeImageQueuecontains tbm_surface_queue_h or is empty
   */
  NativeImageQueueTizenVulkan(uint32_t queueCount, uint32_t width, uint32_t height, Any nativeImageQueue);

  void Initialize(Dali::NativeImageQueue::ColorFormat colorFormat);
...
#endif // DALI_INTERNAL_NATIVE_IMAGE_QUEUE_IMPL_TIZEN_VULKAN_H
