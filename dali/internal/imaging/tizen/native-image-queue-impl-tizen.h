#ifndef DALI_INTERNAL_NATIVE_IMAGE_QUEUE_IMPL_TIZEN_H
#define DALI_INTERNAL_NATIVE_IMAGE_QUEUE_IMPL_TIZEN_H
 ...
 */
class NativeImageQueueTizen : public Internal::Adaptor::NativeImageQueue
{
public:
  /**
   * Create a new NativeImageQueueTizen internally.
   ...
   */
  static NativeImageQueueTizen* New(uint32_t queueCount, uint32_t width, uint32_t height, Dali::NativeImageQueue::ColorFormat colorFormat, Any nativeImageQueue);
   ...
   * destructor
   */
  ~NativeImageQueueTizen() override;
...
private:
   ...
   * @param[in] nativeImageQueuecontains tbm_surface_queue_h or is empty
   */
  NativeImageQueueTizen(uint32_t queueCount, uint32_t width, uint32_t height, Any nativeImageQueue);
