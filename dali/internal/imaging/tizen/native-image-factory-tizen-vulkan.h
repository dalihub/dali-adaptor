#ifndef DALI_INTERNAL_NATIVE_IMAGE_FACTORY_VULKAN_H
#define DALI_INTERNAL_NATIVE_IMAGE_FACTORY_VULKAN_H
...
namespace Adaptor
{
class NativeImageFactoryTizenVulkan : public NativeImageFactory
{
public:
