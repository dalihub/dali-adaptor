 ...
 */
class NativeImageQueueAndroid : public Internal::Adaptor::NativeImageQueue
{
public:
  /**
   * Create a new NativeImageQueueAndroid internally.
   ...
   */
  static NativeImageQueueAndroid* New(uint32_t queueCount, uint32_t width, uint32_t height, Dali::NativeImageQueue::ColorFormat colorFormat, Any nativeImageQueue);
   ...
   * destructor
   */
  ~NativeImageQueueAndroid() override;
...
private:
   ...
   * @param[in] nativeImageQueuecontains tbm_surface_queue_h or is empty
   */
  NativeImageQueueAndroid(uint32_t queueCount, uint32_t width, uint32_t height, Dali::NativeImageQueue::ColorFormat colorFormat, Any nativeImageQueue);
