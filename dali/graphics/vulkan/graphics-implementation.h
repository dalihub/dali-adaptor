...
/**
 * Interface class for vulkan graphics to implement
 */
class GraphicsImpl
{
  virtual void DestroySurface( Graphics::FBID framebufferId ) = 0;
  virtual void C
};
...
private:
  std::unique_ptr<Dali::Graphics::Internal::GraphicsImpl> mGraphicsImpl;
};
