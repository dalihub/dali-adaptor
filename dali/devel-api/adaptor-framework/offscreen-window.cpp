...
void OffscreenWindow::SetNativeImage(Dali::NativeImageInterfacePtr nativeImage)
{
  Internal::Adaptor::GetImplementation(*this).SetNativeImage(nativeImage);
}

Dali::NativeImageInterfacePtr OffscreenWindow::GetNativeImage() const
{
  return Internal::Adaptor::GetImplementation(*this).GetNativeImage();
}
