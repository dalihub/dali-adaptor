...
Dali::InputMethod::PanelLayout InputMethodOptions::GetPanelLayout() const
{
  return mImpl->mPanelLayout;
}

Dali::InputMethod::PanelLayoutVariation InputMethodOptions::GetPanelLayoutVariation() const
{
  return mImpl->mPanelLayoutVariation;
}
